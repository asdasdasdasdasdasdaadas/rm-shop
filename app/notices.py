...
DEFAULT_NOTICES: dict[str, str] = {
    ...
    "support_welcome": (
        ...
        "Мы развиваем {brand} и хотим, чтобы пользоваться VPN было просто и удобно. "
        "Если что-то не работает или кажется непонятным — расскажите нам.\n\n"
        "Напишите в поддержку: поможем разобраться и учтём ваши замечания. "
        "Идеям и предложениям тоже будем рады.\n\n"
        "Поможете сделать сервис лучше?"
    ),
    "info_nudge": (
        "Как у нас устроено.\n\n"
...
NOTICE_FIELDS: list[dict[str, str]] = [
    ...
    {"key": "support_welcome", "title": "Помогите нам стать лучше", "hint": "{brand}"},
