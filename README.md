...
Режим `BALANCE_ENABLED=true` включает баланс в рублях: сутки VPN на одно устройство стоят `VPN_DAY_PRICE_RUB` (по умолчанию 6), пополнение шагом 50 руб. (50–400), вывод недоступен. Реферал: по `REFERRAL_REWARD_RUB` (50) пригласившему и другу. По умолчанию режим выключен.
...
| --- | --- | --- | --- |
| Пригласивший | дни подписки или, при балансе, рубли | `REFERRAL_REWARD_DAYS` / `REFERRAL_REWARD_RUB` | 7 дн. / 50 руб. |
| Друг по ссылке | плюс к бесплатному периоду или, при балансе, те же рубли | `REFERRAL_INVITEE_DAYS` / `REFERRAL_REWARD_RUB` | 5 дн. / 50 руб. |
